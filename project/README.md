...
How to create a backup using pg_dump

How to restore the database using pg_restore or psql

Suggested backup frequency and usage (for real deployments vs course demo)
...
docs/report.md (optional)	Detailed Report	Written explanation of schema, normalization, queries, transactions, indexing, and backup strategy.
5. How to Run
