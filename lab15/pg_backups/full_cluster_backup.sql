...
\restrict 6MbazaYcSkZWSnIAvfpjfI4h0GOhBRHKrgNGPV0dOgspc22NNdc9neEkCESTUV5
...
ALTER ROLE postgres WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:G/G1fZ919pI6XWLnKGGFjw==$9hTe7ITLbUOeJM1AcLK/IhHKpZOJAtxe6hn/skbXNNg=:6eJf9wGX2konOncQT0UrnPQ0IImce1UAB3edQL5nNZU=';
...
\unrestrict 6MbazaYcSkZWSnIAvfpjfI4h0GOhBRHKrgNGPV0dOgspc22NNdc9neEkCESTUV5
...
\restrict WmcerEkZ9krjmwd5hqdt6nvY1SLnQxuo1Xm5Iw2uTmTuWvGl2CRN0Gb3NFiU7Ug
...
\unrestrict WmcerEkZ9krjmwd5hqdt6nvY1SLnQxuo1Xm5Iw2uTmTuWvGl2CRN0Gb3NFiU7Ug

--
-- Database "db_from_sql" dump
--
...
\restrict Qp7SQV9AbCtUIubxYK91t5b4RJWYKwGiNYaFjInF3GOyv3uuT61VyrhpcRBPyhW
...
--
-- Name: db_from_sql; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE db_from_sql WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'C.UTF-8';


ALTER DATABASE db_from_sql OWNER TO postgres;

\unrestrict Qp7SQV9AbCtUIubxYK91t5b4RJWYKwGiNYaFjInF3GOyv3uuT61VyrhpcRBPyhW
\connect db_from_sql
\restrict Qp7SQV9AbCtUIubxYK91t5b4RJWYKwGiNYaFjInF3GOyv3uuT61VyrhpcRBPyhW
...
\restrict ggVPwepJaOigtWeORb9V2mYayYJScEhV9trDoflQTIFZc9RzsuXdpk5i1hRVtb2
...
--
-- Name: db_parallel; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE db_parallel WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'C.UTF-8';


ALTER DATABASE db_parallel OWNER TO postgres;

\unrestrict ggVPwepJaOigtWeORb9V2mYayYJScEhV9trDoflQTIFZc9RzsuXdpk5i1hRVtb2
\connect db_parallel
\restrict ggVPwepJaOigtWeORb9V2mYayYJScEhV9trDoflQTIFZc9RzsuXdpk5i1hRVtb2
...
\restrict Kc7RBdlcedVwXCKJVaN1xMutc1jOgIcCvVHWdqUmChrRsa1D8VIWkY7FMw4izsw
...
--
-- Name: db_tables_only; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE db_tables_only WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'C.UTF-8';


ALTER DATABASE db_tables_only OWNER TO postgres;

\unrestrict Kc7RBdlcedVwXCKJVaN1xMutc1jOgIcCvVHWdqUmChrRsa1D8VIWkY7FMw4izsw
\connect db_tables_only
\restrict Kc7RBdlcedVwXCKJVaN1xMutc1jOgIcCvVHWdqUmChrRsa1D8VIWkY7FMw4izsw
...
\restrict cIdqpm6kwMvBpHjOjirgPaj5OaoTXeAj069hdyItaTnUYuhCJGNxvkVaa1w8OGG
...
CREATE DATABASE new_database WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'C.UTF-8';


ALTER DATABASE new_database OWNER TO postgres;

\unrestrict cIdqpm6kwMvBpHjOjirgPaj5OaoTXeAj069hdyItaTnUYuhCJGNxvkVaa1w8OGG
...
\restrict IGsIK9wtGMrukrI4sLHUcX02cmVnwR8c79dpWSnNvrtV8m9rLxrsR1U2du6kVNQ
...
\unrestrict IGsIK9wtGMrukrI4sLHUcX02cmVnwR8c79dpWSnNvrtV8m9rLxrsR1U2du6kVNQ

--
-- Database "target_database" dump
--
...
\restrict 9beiXAzN7jZrddpl2ZLmI7o6WugGtXsCBTAPdfg47wT0wmy9ubaInOZQAfyzII8
...
--
-- Name: target_database; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE target_database WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'C.UTF-8';


ALTER DATABASE target_database OWNER TO postgres;

\unrestrict 9beiXAzN7jZrddpl2ZLmI7o6WugGtXsCBTAPdfg47wT0wmy9ubaInOZQAfyzII8
...
\restrict FCP4TNHdResDexIoeBp7MOyslzPGTBUPQhivx6pIfhEk4yxGe9xj8p0ThPSLTap
...
CREATE DATABASE university WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'C.UTF-8';


ALTER DATABASE university OWNER TO postgres;

\unrestrict FCP4TNHdResDexIoeBp7MOyslzPGTBUPQhivx6pIfhEk4yxGe9xj8p0ThPSLTap
\connect university
\restrict FCP4TNHdResDexIoeBp7MOyslzPGTBUPQhivx6pIfhEk4yxGe9xj8p0ThPSLTap
